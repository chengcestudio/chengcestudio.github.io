...
var Linkedin = Svg({
  title: 'Linkedin',
  d: 'M142.46,67.71H118.82a2.38,2.38,0,0,0-2.37,2.37V93.72a2.38,2.38,0,0,0,2.37,2.37h23.64a2.37,2.37,0,0,0,2.37-2.37V70.08A2.37,2.37,0,0,0,142.46,67.71ZM124.73,92h-4.14V78.35h4.14Zm-2.49-15.4a2.66,2.66,0,1,1,3.05-3A2.69,2.69,0,0,1,122.24,76.55Zm18.45,15.57h-4.13V85.54c0-2.31-.56-3.61-2-3.61-2,0-2.76,1.4-2.76,3.61v6.58h-4.14V78.53h3.84v1.93a4.41,4.41,0,0,1,4.1-2.11c4.1,0,5.06,2.21,5.06,6.27Z'
});

/***/ })

})
//# sourceMappingURL=2018_accademia.js.2a46fc2a57a526c5f28f.hot-update.js.map